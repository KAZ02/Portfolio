...
namespace _0H02031譜久嶺和沙ckadai01
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(textBox1.Text, out month))
            {
                switch (month)
                {
                    ...
                    default:
                        SoundPlayer simpleSound5 = new SoundPlayer("JW1.wav");
                        simpleSound5.Play();
                        MessageBox.Show("1～12を入力してください");
                        break;
                }
            }
            else
            {
                SoundPlayer simpleSound5 = new SoundPlayer("JW2.wav");
                simpleSound5.Play();
        ...
        private void pointer_Paint(object sender, PaintEventArgs e)
        {
